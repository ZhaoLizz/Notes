...
- 添加依赖库 compile 'com.android.support:design:24.2.1' compile 'de.hdodenhof:circleimageview:2.1.0'
- 准备menu，创建menu文件夹，用来显示NavigationView中具体的菜单项
- 准备headerLayout，在layout文件夹中，这个是滑动开后上方的布局
- 在DrawerLayout中加入菜单布局NavigationView
- 处理菜单点击事件
